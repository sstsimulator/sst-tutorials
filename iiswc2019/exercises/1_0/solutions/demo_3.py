...
#########################################################################
core_cache.connect( (core, "cache_link", "100ps"), (l1_cache, "high_network_0", "100ps") )
l1_l2_cache.connect( (l1_cache, "low_network_0", "100ps"), (l2_cache, "high_network_0", "100ps") )
...
sst.setStatisticOutputOptions( { "filepath"  : "stats_demo-3.csv" })
...
print "\nCompleted configuring the Demo_3 model\n"
