...
for core_id in range (0, numCores):
   ...
   core_cache_link.connect( (core, "cache_link", "100ps"), (l1_cache, "high_network_0", "100ps") )

   l1_l2_link = sst.Link("l1_to_l2_" + str(core_id))
   l1_l2_link.connect( (l1_cache, "low_network_0", "100ps"), (l2_cache, "high_network_0", "100ps") )

   bus_l2 = sst.Link("bus_to_l2_" + str(core_id))
   bus_l2.connect( (l2_cache, "low_network_0", "100ps"), (bus, "high_network_" + str(core_id), "100ps") )
...
link_dir_mem.connect( (bus, "low_network_0", "50ps"), (memctrl, "direct_link", "50ps") )
