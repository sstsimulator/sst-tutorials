...
#########################################################################
core_0_cache_0.connect( (core_0, "cache_link", "100ps"), (l1_cache_0, "highlink", "100ps") )
core_1_cache_1.connect( (core_1, "cache_link", "100ps"), (l1_cache_1, "highlink", "100ps") )

l1_0_bus.connect( (l1_cache_0, "lowlink", "100ps"), (bus, "highlink0", "100ps") )
l1_1_bus.connect( (l1_cache_1, "lowlink", "100ps"), (bus, "highlink1", "100ps") )

bus_l2.connect( (bus, "lowlink0", "100ps"), (l2_cache, "highlink", "100ps") )
