...
for next_active_core in range(config.total_cores):
    print "Configuring core %d..."%next_active_core
...
for next_mem_ctrl in range(config.num_memory_controllers):	
...
print "Completed configuring the EX6 model"
