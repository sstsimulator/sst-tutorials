...
#########################################################################
core_cache.connect( (core, "cache_link", "100ps"), (cache, "highlink", "100ps") )
cache_mem.connect( (cache, "lowlink", "100ps"), (memctrl, "highlink", "100ps") )
...
sst.setStatisticOutputOptions( { "filepath"  : "stats_demo-2.csv" })
...
print ("\nCompleted configuring the Demo_2 model\n")
